...
public class IteratorEx {
	 ...
	 * 
	 * Trying to remove numbers from the ArrayList while iterating through it using
	 * a regular enhanced for loop. However, this will lead to a
	 * ConcurrentModificationException because we're modifying the list's structure
